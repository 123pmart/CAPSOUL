      ...
      <SceneViewport className="md:w-full">
        <div className="scene-shell scene-shell-warm scene-pad md:w-full" {...sceneBindings}>
          <div className="relative z-10 flex flex-col gap-[var(--mobile-section-gap)] overflow-visible md:min-h-0 md:gap-4 lg:gap-5">
            ...
            <div className="hidden md:grid md:min-h-0 md:grid-cols-[minmax(0,1.03fr)_minmax(19.5rem,0.9fr)] md:items-start md:gap-4 lg:gap-5">
                          ...
                          return (
                            <motion.button
                              ...
                              className={`rounded-full border px-3 py-2 text-center text-[0.75rem] uppercase tracking-[0.16em] ${
                                isActive
                                  ? "border-white/88 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(231,239,247,0.98))] text-[var(--text-primary)] shadow-[0_18px_34px_rgba(152,169,189,0.2)] md:border-[rgba(222,238,255,0.24)] md:bg-[linear-gradient(180deg,rgba(31,48,69,0.96),rgba(19,31,46,0.99))] md:shadow-[0_20px_46px_rgba(2,8,17,0.34)]"
                                  : "border-[rgba(181,196,211,0.28)] bg-[linear-gradient(180deg,rgba(255,255,255,0.48),rgba(243,248,252,0.68))] text-[var(--text-secondary)] md:border-[rgba(176,203,231,0.12)] md:bg-[linear-gradient(180deg,rgba(15,24,36,0.8),rgba(11,18,28,0.9))]"
                              }`}
                            >
                              {step.chip}
                            </motion.button>
                        ...
                        <div className="scene-media-shell min-h-0">
                          <div className="scene-media-frame film-frame relative overflow-hidden">
                            ...
                            <img
                              ...
                              style={{ objectPosition: activeSupport.objectPosition }}
                            />
                            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(232,239,246,0.16))] md:bg-[linear-gradient(180deg,rgba(4,10,16,0.08),rgba(4,10,16,0.42))]" />
