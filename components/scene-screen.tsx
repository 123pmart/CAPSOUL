...
export function SceneScreen({
  ...
  const scenePortraitBody = (
    <div className="scene-screen-portrait-grid scene-balanced-row portrait-tablet-main-grid md:grid md:grid-cols-[minmax(0,1.02fr)_minmax(16.8rem,0.98fr)] md:items-center md:gap-3">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="scene-screen-portrait-media-shell scene-media-shell min-h-0">
                  <div className="scene-screen-portrait-media-frame scene-media-frame scene-media-visual-frame film-frame relative overflow-hidden">
          ...
          <div className={`scene-page-frame scene-screen-frame scene-shell ${toneClassName} scene-pad md:w-full`} {...sceneBindings}>
            <div className="scene-page-group scene-screen-stack relative z-10 flex flex-col gap-[var(--mobile-section-gap)] overflow-visible md:min-h-0 md:gap-3 min-[1025px]:gap-5">
              ...
              {isTabletLandscapeViewport ? (
                <div className="scene-tablet-branch scene-balanced-row scene-composition-row scene-balanced-composition md:grid md:min-h-0 md:grid-cols-[minmax(0,1.03fr)_minmax(17rem,0.97fr)] md:items-center md:gap-3">
                  ...
                  <div className="scene-screen-tablet-media-panel scene-composition-side-panel scene-focus scene-panel-shell flex h-full min-h-[15.8rem] flex-col gap-2.5 p-2.5">
                    <AnimatePresence mode="wait">
                      ...
                      >
                        ...
                        <div className="scene-wide-support-card panel rounded-[1rem] p-3">
                          <p className="text-[0.64rem] font-semibold uppercase tracking-[0.15em] text-[var(--accent-deep)]">
                            {active.mediaLabel}
                          </p>
                          <p className="mt-1.5 text-[0.86rem] leading-6 text-[var(--text-secondary)]">
              ...
              {!isTabletLandscapeViewport ? (
                <div className="scene-desktop-branch scene-screen-grid scene-balanced-row scene-composition-row scene-balanced-composition min-[1025px]:grid min-[1025px]:grid-cols-[minmax(0,1.08fr)_minmax(19.5rem,0.92fr)] min-[1025px]:items-center min-[1025px]:gap-5">
                  ...
                  <div className="scene-screen-media-panel scene-composition-side-panel scene-focus scene-panel-shell flex h-full min-h-[19rem] flex-col gap-3 p-3 sm:min-h-[21rem] sm:p-4">
                    <AnimatePresence mode="wait">
                      ...
                      >
                        ...
                        <div className="scene-wide-support-card panel rounded-[1.12rem] p-4">
                          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.16em] text-[var(--accent-deep)]">
                            {active.mediaLabel}
                          </p>
